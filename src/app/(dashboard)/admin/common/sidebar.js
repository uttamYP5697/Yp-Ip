...
export default function Sidebar() {
    ...
    return (
        <>
        {/* <div className="md:hidden block absolute right-0">
        <button
        ...
        <div
            className={` transition-all duration-300 fixed top-0 left-0 z-100 h-full bg-white flex flex-col ${isSidebarOpen ? "md:w-20 w-0" : "md:w-60 w-full"
                }`}
        >
            {/* Header */}
