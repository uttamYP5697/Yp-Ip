...
const VideoBlock = ({setShowFiles , showFiles}) => {
    ...
    return (
        ...
        <div className={`${isRemoved ? 'hidden' : 'block max-w-5xl mx-auto  bg-white p-6 shadow-b-md rounded-b-md '}`}>
            ...
            { showFiles &&
                ...
                {selectedOption === 'StreamAMG' && (
                    <div>
                        ...
                        <div className="space-y-4 flex">
                            <div className="mt-4 w-1/4 h-[100px] mx-2 relative
                  rounded border-2 border-grey-200 bg-gray-50 md:w-52 
                  ...
                  ">
                                ...
                                {inpval.StreamThumbnil && (
                                    <div className=" w-[20px] absolute top-0 left-0">
                                        <ReactPlayer width={"150px"} height={"95px"} url={inpval.StreamThumbnil} controls={false} className=" h-[100px] w-[20px] md:w-52">
                                        </ReactPlayer>
                                    </div>
                                )}
                            </div>
                            <div className="w-full">
                                <label className="block font-medium text-lg mb-1">Video thumbnail *</label>
                        ...
                        " value={inpval.StreamThumbnil}
                                    onChange={(e) => handlechange(e)}
                                />
                                <div className={`${inpval.StreamThumbnil ? 'hidden' : 'block'}`}>
                                    <button className="mt-2  flex items-center gap-1 text-black rounded-full font-semibold">
                                        <span className="  text-[#6221f8]  font-extrabold rounded-full items-center justify-center"> <IoMdAddCircleOutline className="h-[24px] w-[24px] " />  </span> Add image
                                    </button>
                                </div>
                                {inpval.StreamThumbnil && (
                                    <div className=" mt-2 flex text-gray-500 gap-10  items-center">
                                        <button className="hover:underline text-[16px] flex items-center gap-1"> <IoMdRefresh /> Replace</button>
                                        <button onClick={handleRemoveThumbnail} className="hover:underline text-[16px] flex items-center gap-1"> <RiDeleteBin6Fill /> Remove</button>
                                    </div>
                                )}
                            </div>
                        </div>
                ...
                {selectedOption === 'YouTube' && (
                    <div>
                        ...
                        />
                        <div className="space-y-4 flex">
                            <div className="mt-4 w-1/4 h-[100px] mr-4  relative
                 rounded border-2 border-grey-200 bg-gray-50 md:w-52 
                 grid place-items-center border-grey-200 bg-grey-100  text-gray-300
                 ...
                 ">
                                ...
                                {inpval.videoThumbnil && (
                                    <div className=" w-[20px] absolute top-0 left-0">
                                        <ReactPlayer width={"150px"} height={"95px"} url={inpval.videoThumbnil} controls={false} className=" h-[100px] w-[20px] md:w-52">
                                        </ReactPlayer>
                                    </div>
                                )}
                            </div>
            ...
            ">
                                ...
                                {inpval.BrightCoveThumbnil && (
                                    <div className=" w-[20px] absolute top-0 left-0">
                                        <ReactPlayer width={"150px"} height={"95px"} url={inpval.BrightCoveThumbnil} controls={false} className=" h-[100px] w-[20px] md:w-52">
                                        </ReactPlayer>
                                    </div>
                                )}
                            </div>
                        ...
                        " value={inpval.BrightCoveThumbnil}
                                    onChange={(e) => handlechange(e)}
                                />
                                <div className={`${inpval.BrightCoveThumbnil ? 'hidden' : 'block'}`}>
                                    <button className="mt-2  flex items-center gap-1 text-black rounded-full font-semibold">
                                        <span className="  text-[#6221f8]  font-extrabold rounded-full items-center justify-center"> <IoMdAddCircleOutline className="h-[24px] w-[24px] " />  </span> Add image
                                    </button>
                                </div>
                ...
                {selectedOption === 'Dice' && (
                  ...
                  ">
                                ...
                                {inpval.DiceThumbnil && (
                                    <div className=" w-[20px] absolute top-0 left-0">
                                        <ReactPlayer width={"150px"} height={"95px"} url={inpval.DiceThumbnil} controls={false} className=" h-[100px] w-[20px] md:w-52">
                                        </ReactPlayer>
                                    </div>
                                )}
                            </div>
                    ...
                    {isMenuopen &&
                        <div className="absolute ">
                            <div className="z-1 ">
                                {isMenuopen && (
                                    <div ref={dropdownRef}
                                        className={`w-52  left-30 pointer-left absolute rounded bg-white border-2 border-grey-200 shadow p-1 space-y-1`}>
                                        <ul className="p-1">
                                            <li className="">
                                                <button
